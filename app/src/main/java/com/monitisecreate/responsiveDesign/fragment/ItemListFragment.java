 ...
 * item is currently being viewed in a {@link com.monitisecreate.responsiveDesign.fragment.ItemDetailFragment}.
 * <p/>
...
public class ItemListFragment extends ListFragment {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(DummyContent.sItems.get(position).id);
    }
